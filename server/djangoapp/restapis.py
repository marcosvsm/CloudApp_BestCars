...
def get_dealer_reviews_from_cf(url, **kwargs):
    ...
    if id:
        ...
        json_result = get_request(url,id=1)
    if json_result:
        reviews = json_result
        print(reviews)
...
# - Get the returned sentiment label such as Positive or Negative
    apikey = "rvFiSMVtG2TQw-e0FPhq4zdm62m8ewA0j0OKvcOn_26r"
    url = "https://api.au-syd.natural-language-understanding.watson.cloud.ibm.com/instances/3b39a0d1-de9a-4d0b-8920-da4654be5548"
